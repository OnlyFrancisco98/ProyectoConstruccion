...
* The original package name 'com.proyectoConstruccion.sistema-ventas-login' is invalid and this project uses 'com.proyectoConstruccion.sistema_ventas_login' instead.
